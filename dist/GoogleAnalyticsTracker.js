...
class GoogleAnalyticsTracker {
    ...
    trackEvent(category, action, eventMetadata, payload = null) {
        this.transformPayload(payload);
        AnalyticsBridge.trackEvent(this.id, category, action, eventMetadata && eventMetadata.label, eventMetadata && eventMetadata.value && eventMetadata.value.toString(), payload);
    }
    /**
